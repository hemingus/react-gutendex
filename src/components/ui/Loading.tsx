        ...
        <div>
            <div className="relative w-[200px] h-[400px] mx-auto animate-spin-slow">
                {categories.map((item, index) => {
                    ...
                    className="bg-slate-600 w-[50px] h-[50px] absolute top-1/2 left-1/2 bg-cover bg-center rounded-full -translate-x-1/2 -translate-y-1/2 text-sm animate-blink-slow"></li>
                })}
            </div>
